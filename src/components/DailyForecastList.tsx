...
export const DailyForecastList = ({ forecasts }: Props) => {
  ...
  return (
    <View className="mt-4">
      <Text className="text-xl text-indigo-950 mb-4 px-2 font-raleway-bold">
        ...
        {forecasts.map((day) => (
          ...
          >
            <View className="flex-1">
              <Text className="text-lg text-indigo-950 font-raleway-bold">
                {formatDayLabel(day.date)}
              </Text>
              <Text className="text-indigo-700 capitalize font-raleway">
                {day.weatherDescription}
              </Text>
            </View>

            <View className="flex-row items-center">
              <Text className="text-xl text-indigo-950 mr-2 font-raleway-semibold">
